...
public abstract class AbstractCanalConsumer implements InitializingBean {
	...
	protected static final Logger LOGGER = LoggerFactory.getLogger(AbstractCanalConsumer.class);
    ...
    //
    protected int 	batchSize = Integer.valueOf(Global.getExtendConfig("canal.batchSize","canal-config",  "canal.properties"));
    //当binlog没有数据时，主线程等待的时间，单位ms,大于0
    protected int 	waitingTime = Integer.valueOf(Global.getExtendConfig("canal.waitingTime","canal-config",  "canal.properties"));
    ...
    public AbstractCanalConsumer(String destination) {
		super();
		this.destination = destination;
	}

	public AbstractCanalConsumer(String destination, CanalConnector connector) {
		super();
		this.destination = destination;
...
//    public abstract void delete(CanalEntry.Header header,List<CanalEntry.Column> beforeColumns);
    ...
    private void rowData(CanalEntry.Entry entry) throws Exception {
        ...
        try {
            ...
            Object rowChangeObj = buildRowChange(header.getSchemaName(),header.getTableName(),eventType , rowChange.getRowDatasList(),sql);
        	
            catChange(rowChangeObj);
     ...
     * @param list
     */
    protected Object buildRowChange(String schemaName, String tableName, CanalEntry.EventType eventType, List<RowData> rowData,String sql) throws Exception{
    	return new CanalRowChange(schemaName, tableName, eventType, rowData, sql);
    }
    
    
    protected abstract void catChange(Object rowChangeObj) throws Exception;
